...
const actions = ["session", "bootstrap", "get_catalog", "get_customers", "get_order_events", "create_order", "transition_order", "save_fulfilment", "save_dispatch", "confirm_delivery", "edit_order", "create_exception", "resolve_exception", "schedule_installation", "complete_installation", "list_users", "upsert_user"];
