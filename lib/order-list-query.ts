...
const allowedStatuses = new Set([
  'all', 'open', 'history', 'billing', 'billing_attention', 'picking', 'dispatch_ready', 'delivery_attention', 'delivery_due_today', 'delivery_due_soon', 'back_ordered', 'delivery_exception', 'priority_high', 'priority_urgent', 'overdue', 'attention',
